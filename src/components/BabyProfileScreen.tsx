/**
 * BabyProfileScreen Component
 * 
 * Detailed baby profile displaying:
 * - Baby's basic information (age, birth date)
 * - Growth metrics with percentiles (weight, height, head circumference)
 * - Developmental milestones with achievement tracking
