/**
 * LifestyleScreen Component
 * 
 * Wellness and lifestyle management featuring:
 * - Parent wellness tracking (sleep, self-care, stress levels, support score)
 * - Baby wellness metrics (sleep, nutrition, activity, development)
 * - Personalized recommendations for improvement
 * - Tabbed interface for family wellness overview
