/**
 * ProductRecalls Component
 * 
 * Product recall management system featuring:
 * - Live recall data from Supabase database
 * - Search and filter functionality
 * - Severity-based categorization (urgent, moderate, informational)
 * - Tabbed view by status (active, archived)
 * - Detailed recall information (dates, hazards, remedies)
 * - External links to manufacturer information
...
export function ProductRecalls({ isOpen, onClose }: ProductRecallsProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl mx-auto max-h-[90vh] overflow-hidden">
        <DialogHeader>
